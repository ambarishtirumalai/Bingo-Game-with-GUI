...
heading_font = tkFont.Font(family="Helvetica", size=36, weight="bold", slant="italic", underline=True)

# Add a heading to the main window with the specified font properties
heading_label = Label(root, text="Bingo!", font=heading_font, bg='lightblue', fg='blue',
                    bd = 5, relief = "solid")
